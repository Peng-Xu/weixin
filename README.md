...
> **重要说明**：经调研，ComWeChatRobot 项目已停更 3 年（最后支持微信 3.7.x），无法用于当前微信版本。本项目采用 **WeChatFerry**—2026 年最活跃的微信 Hook 方案，支持微信 PC **3.9.12.17 / 3.9.12.51 / 4.1.8**。
...
- **Python 3.10+**
- **微信 PC 客户端 3.9.12.17 或 3.9.12.51 或 4.1.8**

> 微信版本很关键！请从 WeChatFerry 仓库的 Release 页面下载对应版本安装包，并**关闭自动更新**。
> 微信 4.1.8 用户请确保安装了支持 4.x 的 wcferry 版本。
...
2. **版本锁定**：必须使用 WeChatFerry 支持的微信版本（3.9.12.x 或 4.1.8），关闭自动更新
